...
#     data_path = '/Users/mehdikhosravi/Master/Thesis/STVT-main/STVT/datasets/datasets/'+str(args.dataset)+".h5"
...
def select_keyshots(
    ...
    data_path = (
        "/Users/mehdikhosravi/Master/Thesis/STVT-main/STVT/datasets/datasets/"
        + str(args.dataset)
        + ".h5"
    )
    data_file = h5py.File(data_path)
